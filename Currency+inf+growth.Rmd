...
Research Question: 
A coffee shop faces the question of which advertising measure should be concentrated in the future. For this purpose, customer data has been collected for more than a year, which now has to be statistically analyzed. Concentrate on the following basic question:
 

. How do the different promotions affect sales, average billing and number of customers?
. Are these effects different for each occupational group?
. Does the promotion have an impact on the sale of sustainable coffee, possibly different by occupational group?
